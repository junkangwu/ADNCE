...
if __name__ == '__main__':
    ...
    for epoch in range(1, epochs + 1):
        ...
        if epoch % 5 == 0:
            ...
            print("Epoch:{}\t{}\t{}\t{}".format(epoch, test_loss, test_acc_1, test_acc_5))
            # os.makedirs('../results/')
            try:
                results=pickle.load( open( './outputs_/summary.pkl', "rb" ))
            except:
                results={}
            results[model_path]=test_acc_1
            # print(results)
            pickle.dump(results, open( './outputs_/summary.pkl', "wb" ) )
