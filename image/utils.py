...
def get_dataset_small_batch(dataset_name, root='../data', pair=True, noise_mode=None, stage1=None, logger=None):
    if pair:
        if dataset_name=='cifar10':
            train_data = CIFAR10Pair_idx(root=root, train=True, transform=train_transform, download=False)
...
def get_dataset(dataset_name, root='../data', pair=True, noise_mode=None, stage1=None, logger=None):
    if pair:
        if dataset_name=='cifar10':
            print(root)
